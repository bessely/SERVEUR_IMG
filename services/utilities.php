<?php
    ...
    */
    ...
    function extractUri(): array{
        ...
        // exit(var_dump(compact("route", "service", "query")));
        return compact("route", "service", "query");
    }

    function getRequest($url){
        $lastParam = basename(parse_url($url, PHP_URL_PATH));
        return $lastParam;
    }
    /**
    ...
    */
    function catchRequest(){
        ...
        response("[ Bienvenue sur ".APPNAME." Version ".VERSION." Développé par besselymail@gmail.com ] Spécifier un service pour démarrer.", 404);
    }
